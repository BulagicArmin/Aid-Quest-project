...
s3 = boto3.resource(
    's3',
    aws_access_key_id='AKIAYU4HXTRNJAT7R5HZ',
    aws_secret_access_key='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',
...
#SECRET_KEY = 'i0$io&-j-bgsucxo#wj741+r_5%ev9!^*9x(x958omd1vr$%nq'
SECRET_KEY = os.environ.get('SECRET_KEY')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['aidquest.herokuapp.com']
